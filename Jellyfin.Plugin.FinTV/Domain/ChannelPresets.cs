...
public static class ChannelPresets
{
    ...
    [
        ...
        Preset(121, 119.3m, "[OpenSwim]", ChannelContentType.TvShow, "TV Shows", "Nick, Disney, Fox Kids, and Cartoon Network style kids TV/movies; any year; TV-PG max", "fintv-open-swim", "Shows/[open_swim].png", catalogMode: ChannelCatalogMode.Mixed, maxRating: "TV-PG"),
        ...
        Preset(134, 126.3m, "YouTube TV", ChannelContentType.TvShow, "TV Shows", "Content from Jellyfin TV library YouTube only", "fintv-youtube", "Shows/YouTube_TV.png"),
        ...
        Preset(205, 203.3m, "That's Funny", ChannelContentType.Movie, "Movies", "Comedian movies and tv shows", "fintv-funny", "Movies/That's_Funny.png", catalogMode: ChannelCatalogMode.Mixed),
