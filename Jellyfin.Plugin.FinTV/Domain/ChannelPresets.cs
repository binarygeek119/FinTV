...
public static class ChannelPresets
{
    ...
    [
        ...
        Preset(123, 1.5m, "BinaryGeek119 News & Weather", ChannelContentType.Weather, "TV Shows", "News and weather channel", "fintv-news-weather", "EBS/offlineusa.jpg", weather: true),
