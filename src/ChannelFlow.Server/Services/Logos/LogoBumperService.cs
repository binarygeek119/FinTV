...
/// <summary>
/// Local bundled bumpers inserted into playout (Slappy's Toon Takeover opener).
/// </summary>
public sealed class LogoBumperService
{
    public const string ToonTakeoverRelativePath = "Slappy/slappy's_toon_takeover.mp4";
