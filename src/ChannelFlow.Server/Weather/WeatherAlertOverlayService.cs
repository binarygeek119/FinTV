...
public sealed class WeatherAlertOverlayService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return _compositor.RenderJpeg(snap, WeatherStarScreen.Hazards, skin, 854, 480, radarIndex: 0);
    }

    private static WeatherSnapshot PreviewSnapshot(IReadOnlyList<WeatherAlert> alerts)
    {
        var location = WeatherStarChannelService.ResolveLocationQuery(null);
